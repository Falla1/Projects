...
public class DNSDB {
    ...
    public DNSDB(BlockFile bf, boolean value){
    	if(value == true)
    		hostNames = new BPlusTreeIntToString60(bf,true);
    	else
    		ipAddresses = new BPlusTreeString60toInt(bf,true);
    }
    
    public DNSDB(BlockFile bf,String string){
    	if(string.equals("i"))
    		hostNames = new BPlusTreeIntToString60(bf);
    	else
    		ipAddresses = new BPlusTreeString60toInt(bf);
    }
