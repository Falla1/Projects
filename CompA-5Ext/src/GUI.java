...
public class GUI extends JFrame{
	...
	JButton saveFileInt = new JButton("Save Int - String File");
	saveFileInt.setMaximumSize(new Dimension(250, 50));
	saveFileInt.addActionListener(new ActionListener() {
			
		@Override
		public void actionPerformed(ActionEvent e) {
		    JFileChooser chooserLoad = new JFileChooser(".");//System.getProperty("user.dir"));
		    int resLoad = chooserLoad.showOpenDialog(GUI.this);
		    JFileChooser chooser = new JFileChooser(".");//System.getProperty("user.dir"));
		    int res = chooser.showOpenDialog(GUI.this);
		    if(res == JFileChooser.APPROVE_OPTION){
		    	saveInt(chooser.getSelectedFile(),chooserLoad.getSelectedFile());
		    }
		}
	    });
	
	JButton saveFileString = new JButton("Save String - Int File");
	saveFileString.setMaximumSize(new Dimension(250, 50));
	saveFileString.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
		    ...
		    int res = chooser.showOpenDialog(GUI.this);
		    if(res == JFileChooser.APPROVE_OPTION){
		    	saveString(chooser.getSelectedFile(),chooserLoad.getSelectedFile());
		    }
		}
	    });
	
	JButton loadIntFile = new JButton("Load Int -> String File");
	loadIntFile.setMaximumSize(new Dimension(250, 50));
	loadIntFile.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
		    ...
		    int res = chooser.showOpenDialog(GUI.this);
		    if(res == JFileChooser.APPROVE_OPTION){
		    	loadInt(chooser.getSelectedFile());
		    }
		}
	    });
	
	JButton loadStringFile = new JButton("Load String -> int File");
	loadStringFile.setMaximumSize(new Dimension(250, 50));
	loadStringFile.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
		    ...
		    int res = chooser.showOpenDialog(GUI.this);
		    if(res == JFileChooser.APPROVE_OPTION){
		    	loadString(chooser.getSelectedFile());
		    }
		}
	    });
	...
	buttonPanel.add(Box.createVerticalStrut(5));
	buttonPanel.add(saveFileInt);
	buttonPanel.add(Box.createVerticalStrut(5));
	buttonPanel.add(saveFileString);
	buttonPanel.add(Box.createVerticalStrut(5));
	buttonPanel.add(loadIntFile);
	buttonPanel.add(Box.createVerticalStrut(5));
	buttonPanel.add(loadStringFile);
    ...
    public void saveInt(File f, File file){
    	try {
			BlockFile b = new BlockFile(file.toString(),1024);
			dnsDB = new DNSDB(b,"i");
			dnsDB.load(f);
		} catch (IOException e) {
			e.printStackTrace();
    ...
    public void saveString(File f, File file){
    	try {
			BlockFile b = new BlockFile(file.toString(),1024);
			dnsDB = new DNSDB(b,"s");
			dnsDB.load(f);
    ...
    public void loadInt(File f){
    	try {
			BlockFile b = new BlockFile(f.toString(),1024);
			dnsDB = new DNSDB(b,true);
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
    
    public void loadString(File f){
    	try {
			BlockFile b = new BlockFile(f.toString(),1024);
			dnsDB = new DNSDB(b,false);
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
